<?php
    ...
    /**
    * Class SmartStrategy
     * This is a super defensive both it will always tried to block the attacks by looking at the lines
     * the client had made and those lines have priotities, lines with 4 pieces will be block before lines
     * with 3 pieces and lines with 2 pieces
    */
